...
- Pokémon Vault, Item Storage, and Resources now open in scalable read-only previews, with search, filters, and transactions moved into dedicated full management views.
