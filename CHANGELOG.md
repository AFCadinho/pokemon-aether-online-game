...
- Move, ability, nature, IV, EV, held item, and Poké Ball details in read-only Pokémon Summaries now appear in compact hover cards directly above the selected detail.
