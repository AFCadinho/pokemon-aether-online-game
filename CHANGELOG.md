...
- High-quality rendered Pokémon now use their visible artwork bounds over the existing illustrated Summary backdrop and in Pokédex previews without being replaced by web fallbacks, with lightweight Pokédex list icons, cached front/back views, and an optional local development review catalog.
...
- Wild encounters and trainer battles start reliably, and running away now clearly says “Got away safely!”.
- Trainer battles no longer leave you stuck after a dialogue or reconnect.
- Your mount stays with you when you travel between outdoor areas.
- Battle replays reconnect more smoothly and keep the battle log readable.

### Interface

- Party, battle, chat, summary and guild screens now show the correct game icons.
- Pokémon details and the damage calculator now display the same useful battle information as the game client, including speed tiers and original gender icons.
- Pallet Town’s map visuals have been restored.
- Login and account-loading transitions now match the rest of the game.

### Audio

- Login, map, battle and interface music and sound effects now play through the game’s normal audio system.
