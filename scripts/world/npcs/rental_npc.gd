...
func _rental_explanation() -> Array[String]:
	...
	return [
		...
		"You may rent up to six Pokémon, even before reaching the Kanto level cap of 100, so you can play PvP. You can make an active rental permanent only while your Kanto level cap is 100. The initial rental fee is deducted from the total price.",
