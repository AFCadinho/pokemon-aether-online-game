...
const CODE_TO_KEY: Dictionary = {
	...
	"guild_leadership_transfer_self": "backend.error.guild_leadership_transfer_self",
	"guild_disband_members_remain": "backend.error.guild_disband_members_remain",
	"guild_disband_bank_not_empty": "backend.error.guild_disband_bank_not_empty",
	"guild_disband_active_loans": "backend.error.guild_disband_active_loans",
	"guild_disband_active_clash": "backend.error.guild_disband_active_clash",
	...
	"loan_browser_recipient_unsupported": "ui.lending.error.browser_recipient",
