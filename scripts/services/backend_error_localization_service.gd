...
const CODE_TO_KEY: Dictionary = {
	...
	"aether_clash_entry_closed": "backend.error.aether_clash_challenge_unavailable",
	"aether_clash_spectating_forbidden": "backend.error.aether_clash_permission",
	"aether_clash_portal_required": "backend.error.aether_clash_unavailable",
	"aether_clash_teleport_pending": "backend.error.aether_clash_unavailable",
	"aether_clash_activity_blocked": "backend.error.aether_clash_unavailable",
	"aether_clash_presence_required": "backend.error.aether_clash_unavailable",
