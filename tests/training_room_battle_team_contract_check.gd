...
func _check_level_five_training_ai_uses_the_same_isolation_boundary() -> void:
	...
	_check(
		...
		and api_source.contains("ai_mode in [\"ai4\", \"shadow\", \"intermediate\", \"active\", \"expert\", \"master\", \"nightmare\"]")
	...
	for mode: String in ["ai4", "shadow", "active", "intermediate", "expert", "master", "nightmare"]:
