...
func _init() -> void:
	...
	_check(
		...
		and not player_scene_source.contains('path="res://assets/ui/developer_emblem_refined.png"'),
	...
	_check(
		...
		and role_badge_texture_source.contains('"developer": "res://assets/ui/developer_emblem_refined.png"')
	...
	var developer_badge_image := Image.load_from_file(
		ProjectSettings.globalize_path("res://assets/ui/developer_emblem_refined.png")
	)
	_check(
