...
func _run() -> void:
	...
	_expect("story.mt_moon.cutscene.follower_attack" in controller_source and '"poison"' in controller_source, "Zubat visibly attacks with a bright cave-readable effect")
