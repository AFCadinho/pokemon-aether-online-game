...
func _init() -> void:
	...
	_check(script_source.contains("func _create_trainer_card_redeem_row()") and script_source.contains('redeem_button.text = "Redeem Code"'), "Trainer Card exposes the future Redeem Code action")
	_check(script_source.contains('hint_label.text = "Have a gift code?"'), "redeem action includes concise supporting context")
	_check(script_source.contains('redeem_button.add_theme_constant_override("icon_max_width", 20)') and not script_source.contains("redeem_button.icon_max_width"), "runtime Redeem Code button sizes its icon through a valid theme override")
