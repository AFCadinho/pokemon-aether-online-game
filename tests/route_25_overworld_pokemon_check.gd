...
const MOUNTAIN_POKEMON := {
	"Entities/Pokemon/MountainPokemon/Nacli": ["kanto_route_25_mountain_nacli_1", "nacli", Vector2(1040, 176), 587],
	"Entities/Pokemon/MountainPokemon/Noibat": ["kanto_route_25_mountain_noibat_1", "noibat", Vector2(2128, 656), 587],
