...
func _check_battle_selection_policy_contract() -> void:
	...
	_check_contains(source, "switch_party_label.visible = not is_calc_mode and not is_bag_view and not show_pvp_switch_confirmation", "switch title yields to the accepted PvP switch confirmation")
