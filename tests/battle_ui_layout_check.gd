...
func _check_scene_structure() -> void:
	...
	_check_contains(scene_source, "offset_left = 196.0", "player field indicators sit against the player party preview")
	_check_contains(scene_source, "offset_top = 252.0", "player field indicators sit below the player HP HUD")
	_check_contains(scene_source, "offset_right = -122.0", "opponent field indicators sit against the opponent party preview")
