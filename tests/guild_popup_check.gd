...
func _init() -> void:
	...
	_check_contains(popup_source, "GuildDisbandConfirmationDialog", "solo Leaders can confirm Guild disbanding")
	_check_contains(popup_source, "func _disband_current_guild", "Guild disbanding calls the authoritative service")
	_check_contains(popup_source, "GuildLeadershipTransferDialog_", "Leaders confirm leadership transfer to another member")
	_check_contains(popup_source, "func _transfer_guild_leadership", "leadership transfer calls the authoritative service")
