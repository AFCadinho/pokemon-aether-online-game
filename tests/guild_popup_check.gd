...
func _init() -> void:
	...
	_check_contains(popup_source, '"GuildBankFunds"', "Guild Bank previews shared funds")
	_check_contains(popup_source, '"GuildBankPokemon"', "Guild Bank previews Pokémon storage")
