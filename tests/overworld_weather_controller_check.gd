...
func _init() -> void:
	...
	_check_equal(rain.amount, 560, "rain density stays balanced for the default 2x overworld zoom")
	_check_equal(rain_ground_effects.events_per_second, 40.0, "rain ground impacts stay subtle at the default 2x overworld zoom")
	_check_true(is_equal_approx(rain_ground_effects.effect_color.a, 0.68), "rain ground impacts use softened opacity")
