...
func _init() -> void:
	...
	_check_true(not pallet_source.contains('interaction_id = "pallet_town_fishing_guru_lesson_complete"'), "Fishing Guru return reward uses the trusted NPC claim flow")
	...
	_check_true(fishing_guru_source.contains("_claim_lesson_reward"), "Fishing Guru claims the completion reward authoritatively")
