...
func _run() -> void:
	...
	field_move_service.set("owned_charm_moves", {
		"flash": {"itemName": "Flash Charm", "requiredHm": "hm-flash"},
		"cut": {"itemName": "Cut Charm", "requiredHm": "hm-cut"},
		"strength": {"itemName": "Strength Charm", "requiredHm": "hm-strength"},
		"surf": {"itemName": "Surf Charm", "requiredHm": "hm-surf"},
		"rock-smash": {"itemName": "Rock Smash Charm", "requiredHm": "hm-rock-smash"},
		"waterfall": {"itemName": "Waterfall Charm", "requiredHm": "hm-waterfall"},
	})
	field_move_service.set("owned_hm_item_ids", {
		"hm-flash": true,
		"hm-cut": true,
		"hm-strength": true,
		"hm-surf": true,
