...
func _init() -> void:
	...
	_check(Workspace.trade_window_size_for_viewport(Vector2i(1920, 1080)) == Vector2i(1060, 610), "large viewports use the desired workspace size")
	...
	_check(source.contains("slot.custom_minimum_size = Vector2(74, 84)"), "Pokemon offer slots stay vertically compact")
