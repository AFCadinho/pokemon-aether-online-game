...
func _run() -> void:
	...
	assert(AttackSelection.family_for("Dragon Claw") == "claw_slash")
	assert(AttackSelection.family_for("Fire Fang") == "bite")
	assert(AttackSelection.family_for("Thunder Punch") == "punch")
	assert(AttackSelection.family_for("High Jump Kick") == "kick")
	assert(AttackSelection.family_for("Iron Tail") == "tail")
	assert(AttackSelection.family_for("Wing Attack") == "wing")
	assert(AttackSelection.family_for("Body Slam") == "body_charge")
	...
	assert(AttackSelection.request_for("Dragon Claw", {"claw_slash": "physical_attack_2"}) == "physical_attack_2")
