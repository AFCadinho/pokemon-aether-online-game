...
func _run() -> void:
	...
	_check(not route_hint.z_as_relative and route_hint.z_index == 7, "route hints render above map art and below world actors")
	...
	_check(not door_hint.z_as_relative and door_hint.z_index == 7, "door hints render above map art and below world actors")
