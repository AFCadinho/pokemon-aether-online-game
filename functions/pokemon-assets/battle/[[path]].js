const ROUTE_PREFIX = '/pokemon-assets/battle/';
const SPRITE_PATH = /^pokemon-(?:front|back|shiny-front|shiny-back)-scale1-128-[a-f0-9]{12}\/[a-z0-9-]{1,96}\/(?:animation\.json|sheet\.png)$/;
