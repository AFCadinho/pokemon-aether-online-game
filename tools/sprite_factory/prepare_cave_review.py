"""Prepare an isolated original cave study with only allowlisted review code."""
import argparse
...
def main():
    ...
    marker = project / '.pokeaether-cave-review'
...
[application]
config/name="PokeAether Cave Review"
...
''')
    marker.touch()
    print(f'Prepared isolated cave: {project}')
