"""Prepare an isolated original stadium study with only allowlisted review code."""
import argparse
...
def main():
    ...
    marker = project / '.pokeaether-stadium-review'
    ...
    for relative in [
        ...
        'scripts/battle/arenas/generic/stadium_arena.gd',
        ...
        'tools/sprite_factory/stadium_battle_review.gd',
        'scripts/battle/arenas/generic/stadium_floor.gdshader',
        'scripts/battle/arenas/generic/stadium_screen.gdshader',
        'scripts/battle/arenas/generic/stadium_beam.gdshader',
        'scripts/battle/arenas/generic/stadium_crowd.gdshader',
        'scripts/battle/arenas/generic/stadium_brand.gdshader',
        'assets/ui/logo.png',
...
[application]
config/name="PokeAether Stadium Review"
...
''')
    marker.touch()
    print(f'Prepared isolated stadium: {project}')
